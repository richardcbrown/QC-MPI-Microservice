...
module.exports = (adapter) => {
  return {
    ...
    exists: (nhsNumber) => {
      ...
      const key = ['Fhir', ResourceName.PATIENT, 'by_nhsNumber', nhsNumber];
    ...
    getPatientUuid: (nhsNumber) => {
      ...
      const key = ['Fhir', ResourceName.PATIENT, 'by_nhsNumber', nhsNumber, 'Patient'];
    ...
    setPatientUuid: (nhsNumber, patientUuid) => {
      ...
      const key = ['Fhir', ResourceName.PATIENT, 'by_nhsNumber', nhsNumber, 'Patient', patientUuid];
    ...
    setResourceUuid: (nhsNumber, resourceName, uuid) => {
      ...
      const key = ['Fhir', ResourceName.PATIENT, 'by_nhsNumber', nhsNumber, 'resources', resourceName, uuid];
