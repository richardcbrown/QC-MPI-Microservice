...
describe('lib/cache/patientCache', () => {
  let ctx;
  ...
  describe('byNhsNumber', () => {
    ...
    describe('#setPatientUuid', () => {
      it('should set all patient uuid', () => {
        ...
        const actual = qewdSession.data.$(['Fhir', 'Patient', 'by_nhsNumber', nhsNumber, 'Patient']).getDocument();
        expect(actual).toEqual(expected);
      });
    });
    ...
    describe('#setResourceUuid', () => {
      it('should set all patient uuid', () => {
        ...
        const actual = qewdSession.data.$(['Fhir', 'Patient', 'by_nhsNumber', nhsNumber, 'resources']).getDocument();
        expect(actual).toEqual(expected);
      });
    });
  });
  ...
  describe('byPatientUuid', () => {
    ...
    describe('#set', () => {
      it('should set patient data', () => {
        ...
        const actual = qewdSession.data.$(['Fhir', 'Patient', 'by_uuid', patientUuid, 'data']).getDocument();
    ...
    describe('#setNhsNumber', () => {
      it('should set nhs number', () => {
        ...
        const actual = qewdSession.data.$(['Fhir', 'Patient', 'by_uuid', patientUuid]).getDocument();
    ...
    describe('#deleteAll', () => {
      it('should delete all data', () => {
        ...
        const actual = qewdSession.data.$(['Fhir', 'Patient', 'by_uuid']).getDocument();
        expect(actual).toEqual(expected);
      });
    });
  ...
  describe('byResource', () => {
    ...
    describe('#set', () => {
      it('should set resource uuid', () => {
        ...
        const byNhsNumber = qewdSession.data.$(['Fhir', 'Patient', 'by_nhsNumber', nhsNumber]).getDocument();
        ...
        const byPatientUuid = qewdSession.data.$(['Fhir', 'Patient', 'by_uuid', patientUuid]).getDocument();
