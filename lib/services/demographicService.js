...
const { parseName, parseAddress, parseTelecom, parseEmail } = require('../shared/utils');
...
class DemographicService {
  ...
  getByPatientId(nhsNumber) {
    ...
    const practiionerOrgExists = practitionerUuid 
      && resourceCache.byUuid.existsRelatedUuid(ResourceName.PATIENT, patientUuid, ResourceName.ORGANIZATION);
    ...
    demographics.gpName = (practitionerOrganisation && practitionerOrganisation.name) || 'Not known';
