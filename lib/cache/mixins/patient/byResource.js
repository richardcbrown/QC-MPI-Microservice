...
module.exports = (adapter) => {
  return {
    ...
    exists: (nhsNumber, resourceName) => {
      ...
      const key = ['Fhir', ResourceName.PATIENT, 'by_nhsNumber', nhsNumber, 'resources', resourceName];
    ...
    set: (nhsNumber, patientUuid, resourceName, uuid) => {
      ...
      const byNhsNumberKey = ['Fhir', ResourceName.PATIENT, 'by_nhsNumber', nhsNumber, 'resources', resourceName, uuid];
      adapter.put(byNhsNumberKey, uuid);

      const byUuidKey = ['Fhir', ResourceName.PATIENT, 'by_uuid', patientUuid, 'resources', resourceName, uuid];
